...
[assembly: CommandClass(typeof(Modal.Commands))]
...
namespace Modal
{
  ...
  public class Commands
  {
    ...
    // command line input method for gaining the data
    [CommandMethod("modal")]
    public void modal() // This method can have any name
    {
      // create a new instance of the window
      VerySimpleDatabinding.Window1 modalDlg = new VerySimpleDatabinding.Window1();
      modalDlg.Content = new VerySimpleDatabinding.UserControl1(CompanyDetails.details);
      Application.ShowModalWindow(modalDlg);
    }
  }
}
